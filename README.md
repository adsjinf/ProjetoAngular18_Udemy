...
<h5>
Repositorio para projetos do curso da Udemy  desenvolvido utilizando **Angular 17**, a última versão do popular framework front-end. O objetivo deste projeto é criar uma aplicação web moderna e escalável, aproveitando os recursos mais recentes do Angular.
</h5>
## 📋 Requisitos
